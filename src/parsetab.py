...
_lr_productions = [
  ...
  ('program -> program_part_list','program',1,'p_program','parser.py',25),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',31),
  ('program_part_list -> program_part','program_part_list',1,'p_program_part_list','parser.py',35),
  ('program_part_list -> program_part program_part_list','program_part_list',2,'p_program_part_list','parser.py',36),
  ('program_part -> event_list','program_part',1,'p_program_part','parser.py',44),
  ('program_part -> function_list','program_part',1,'p_program_part','parser.py',45),
  ('event_list -> event','event_list',1,'p_event_list','parser.py',50),
  ('event_list -> event_list event','event_list',2,'p_event_list','parser.py',51),
  ('event -> EVENT STRING LBRACE statement_list RBRACE','event',5,'p_event','parser.py',59),
  ...
  ('statement -> while_statement','statement',1,'p_statement','parser.py',74),
  ('statement -> return_statement','statement',1,'p_statement','parser.py',75),
  ('statement -> comp_statement','statement',1,'p_statement','parser.py',76),
  ('statement -> expression SEMI','statement',2,'p_statement','parser.py',77),
  ('statement -> empty','statement',1,'p_statement','parser.py',78),
  ...
  ('return_statement -> RETURN expression SEMI','return_statement',3,'p_return_statement','parser.py',101),
  ('comp_statement -> LBRACE statement_list RBRACE','comp_statement',3,'p_comp_statement','parser.py',106),
  ('expression -> TYPE ID ASSIGN expression','expression',4,'p_expression','parser.py',111),
  ('expression -> ID ASSIGN expression','expression',3,'p_expression','parser.py',112),
  ('expression -> expression PLUS expression','expression',3,'p_expression','parser.py',113),
  ('expression -> expression MINUS expression','expression',3,'p_expression','parser.py',114),
  ('expression -> expression TIMES expression','expression',3,'p_expression','parser.py',115),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','parser.py',116),
  ('expression -> expression RELOP expression','expression',3,'p_expression','parser.py',117),
  ('expression -> expression AND expression','expression',3,'p_expression','parser.py',118),
  ('expression -> expression OR expression','expression',3,'p_expression','parser.py',119),
  ('expression -> expression ASSIGN expression','expression',3,'p_expression','parser.py',120),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression','parser.py',121),
  ('expression -> NOT expression','expression',2,'p_expression','parser.py',122),
  ('expression -> MINUS expression','expression',2,'p_expression','parser.py',123),
  ('expression -> ID LPAREN RPAREN','expression',3,'p_expression','parser.py',124),
  ('expression -> ID LPAREN args RPAREN','expression',4,'p_expression','parser.py',125),
  ('expression -> expression DOT ID','expression',3,'p_expression','parser.py',126),
  ('expression -> ID','expression',1,'p_expression','parser.py',127),
  ('expression -> INT','expression',1,'p_expression','parser.py',128),
  ('expression -> FLOAT','expression',1,'p_expression','parser.py',129),
  ('expression -> STRING','expression',1,'p_expression','parser.py',130),
  ('expression -> json','expression',1,'p_expression','parser.py',131),
  ('args -> expression','args',1,'p_args','parser.py',144),
  ('args -> args COMMA expression','args',3,'p_args','parser.py',145),
  ('json -> LBRACE json_list RBRACE','json',3,'p_json','parser.py',153),
  ('json_list -> json_pair','json_list',1,'p_json_list','parser.py',158),
  ('json_list -> json_pair COMMA json_list','json_list',3,'p_json_list','parser.py',159),
  ('json_pair -> STRING COLON expression','json_pair',3,'p_json_pair','parser.py',167),
  ('function_list -> ID LPAREN RPAREN comp_statement','function_list',4,'p_function_list','parser.py',172),
  ('function_list -> ID LPAREN var_list RPAREN comp_statement','function_list',5,'p_function_list','parser.py',173),
  ('var_list -> TYPE ID','var_list',2,'p_var_list','parser.py',182),
  ('var_list -> var_list COMMA TYPE ID','var_list',4,'p_var_list','parser.py',183),
]
